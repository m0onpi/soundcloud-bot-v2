  ...
  <MAINGROUP id="uGSDhi" name="MultiOutSynth">
    <GROUP id="{78464AFF-72EB-5BDD-4FD3-6C8C6CF5DFA3}" name="Source">
      <GROUP id="{A6DFE970-77F1-27E9-9B49-A42BC96FECDB}" name="BinaryData">
        <FILE id="NUiTXm" name="singing.ogg" compile="0" resource="1" file="Source/BinaryData/singing.ogg"/>
      </GROUP>
      <FILE id="PCZaNQ" name="MultiOutSynth.cpp" compile="1" resource="0"
            file="Source/MultiOutSynth.cpp"/>
    </GROUP>
  </MAINGROUP>
  <EXPORTFORMATS>
