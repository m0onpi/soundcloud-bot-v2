...
<JUCERPROJECT id="M70qfTRRk" name="Projucer" projectType="guiapp" juceFolder="../../juce"
  ...
  <EXPORTFORMATS>
    ...
    <VS2017 targetFolder="Builds/VisualStudio2017" bigIcon="OCyr5F">
      <CONFIGURATIONS>
        ...
        <CONFIGURATION name="Release" winWarningLevel="4" generateManifest="1" winArchitecture="x64"
                       isDebug="0" optimisation="3" targetName="Projucer"/>
      </CONFIGURATIONS>
      <MODULEPATHS>
        <MODULEPATH id="juce_gui_extra" path="../../modules"/>
        <MODULEPATH id="juce_gui_basics" path="../../modules"/>
  ...
  <MAINGROUP name="Projucer" id="NhrJq66R">
    ...
    <GROUP id="{58EB50D9-0F01-AF9B-087B-93DB283A339D}" name="Utility">
      ...
      <FILE id="zOjz65" name="jucer_ApplicationUsageDataWindowComponent.h"
            compile="0" resource="0" file="Source/Utility/jucer_ApplicationUsageDataWindowComponent.h"/>
    ...
    <GROUP id="{D4241EC8-2982-DB90-D1BE-72E57B735268}" name="BinaryData">
      <GROUP id="{43550888-4716-639C-A179-DDB7011AED08}" name="gradle">
        <FILE id="ns7TQR" name="gradle-wrapper.jar" compile="0" resource="1"
              file="Source/BinaryData/gradle/gradle-wrapper.jar"/>
        <FILE id="NbmM2l" name="gradlew" compile="0" resource="1" file="Source/BinaryData/gradle/gradlew"/>
        <FILE id="Z24qJj" name="gradlew.bat" compile="0" resource="1" file="Source/BinaryData/gradle/gradlew.bat"/>
        <FILE id="lDwfs7" name="LICENSE" compile="0" resource="1" file="Source/BinaryData/gradle/LICENSE"/>
      </GROUP>
